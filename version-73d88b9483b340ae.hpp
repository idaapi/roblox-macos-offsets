...
namespace offsets {
    ...
    inline constexpr uintptr_t spawn = rebase(0x10459352E);
    ...
    inline constexpr uintptr_t luavm_load = rebase(0x1017DD026);
    ...
    inline constexpr uintptr_t lua_setfield = rebase(0x101781FD7);
